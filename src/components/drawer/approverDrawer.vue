<template>
    <el-drawer :append-to-body="true" title="审批人" v-model="visible" class="set_promoter"  
        :with-header="false" :show-close="false" :size="550"
        ...
        <el-tabs v-model="activeName" class="set-tabs" @tab-click="handleTabClick">
            ...
            <el-tab-pane label="按钮设置" name="btnTab">
                <div class="approver_some">
                    <p>🚩审批页面按钮权限显示控制</p>
                    <el-checkbox v-model="checkedOk" label="同意" border style="margin: 6px 0;width: 100%;height: 45px;"/>
                    <el-checkbox v-model="checkedNot" label="不同意" border style="margin: 6px 0;width: 100%;height: 45px;"/>
                    <el-checkbox v-model="checkedBack" label="打回" border style="margin: 6px 0;width: 100%;height: 45px;"/>
                </div>
            </el-tab-pane>
        </el-tabs> 
